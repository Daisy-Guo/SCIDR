...
for j in np.arange(n):
    ...
    np.savetxt("/data02/tguo/batch_effect/allorgan/mat_"+str(fg_lambda*10)+"_"+str(j)+"_scidr.txt",latent_code_mean,fmt="%.5f")
    np.savetxt("/data02/tguo/batch_effect/allorgan/celltype_"+str(fg_lambda*10)+"_"+str(j)+"_scidr.txt",celltype,fmt="%s")
    np.savetxt("/data02/tguo/batch_effect/allorgan/batch_"+str(fg_lambda*10)+"_"+str(j)+"_scidr.txt",batch,fmt="%d")
    np.savetxt("/data02/tguo/batch_effect/allorgan/mat_umap_"+str(fg_lambda*10)+"_"+str(j)+"_scidr.txt",umap_mat,fmt="%.5f")
    np.savetxt("/data02/tguo/batch_effect/allorgan/loss_"+str(fg_lambda*10)+"_"+str(j)+"_scidr.txt",np.array(v),fmt="%.5f")