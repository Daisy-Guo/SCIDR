...
for j in np.arange(n):
    ...
    np.savetxt("/data02/tguo/batch_effect/mouse_cortex/" + str(types) + "_latent_scidr.txt", latent_code_mean,
               fmt="%.5f")
    np.savetxt("/data02/tguo/batch_effect/mouse_cortex/" + str(types) + "_correct_scidr.txt", correct, fmt="%.5f")
