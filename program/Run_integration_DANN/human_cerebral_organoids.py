...
for j in np.arange(n):
    ...
    np.savetxt("/data02/tguo/batch_effect/harmony_data/cerebral_organoids_Kanton_2019_2m/" + str(types),
               latent_code_mean, fmt="%.5f")
    types = "correct_" + str(fg_lambda * 10) + "_" + str(j) + ".txt"
    np.savetxt("/data02/tguo/batch_effect/harmony_data/cerebral_organoids_Kanton_2019_2m/" + str(types), correct,
               fmt="%.5f")