...
for j in np.arange(n):
    ...
    np.savetxt("/data02/tguo/batch_effect/Pancreas/baron_muraro_"+str(types1)+"_SCIDR_latent.txt",latent_code_mean,fmt="%.5f")
    np.savetxt("/data02/tguo/batch_effect/Pancreas/baron_muraro_"+str(types1)+"_SCIDR_correct.txt",correct,fmt="%.5f")
